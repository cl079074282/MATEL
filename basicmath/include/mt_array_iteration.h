...
namespace basicmath {
	...
	public:
		...
		*/
		...
		static int array_cmp(const u8* dst, const u8* src, int ndims, const int* sizes, const int* dst_steps, const int* src_steps, int element_size);
	...
	private:
		...
		static int array_iteration(u8* dst, const u8* src, int ndims, const int* sizes, const int* dst_steps, const int* src_stepse, int element_size, int typ);
	};
