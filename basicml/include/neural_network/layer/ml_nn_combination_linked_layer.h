...
namespace basicml {
	class ml_nn_combination_linked_layer : public ml_nn_linked_layer {
	public:

		virtual ~ml_nn_combination_linked_layer() {}
		...
		virtual ml_nn_combination_linked_layer* to_combination_linked_layer() {return this;}
		virtual const ml_nn_combination_linked_layer* to_combination_linked_layer() const {return this;}

	protected:

		virtual void inner_compute_default_setting();

		Mat m_ff_singal_cache;
